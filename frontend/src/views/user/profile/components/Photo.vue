...
const croppieRef = useTemplateRef('croppir-ref')
let croppie = null
...
function onFileChange(e: { target: { files: any[]; value: string; }; }){
  ...
  reader.onload = () => {
    openModal(reader.result as string)   // 直接传图片地址
  }
  reader.readAsDataURL(file)            // 关键：开始读取
}
...
<template>
  ...
  <dialog ref="modal-ref" class="modal">
    <div class="modal-box transition-none">
      ...
      <div ref = "croppir-ref" class="flex flex-col justify-center my-4"></div>
